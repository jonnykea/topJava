...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.BETWEEN, query = "SELECT m FROM Meal m WHERE m.user.id=:user_id AND m.dateTime>=:start_time AND m.dateTime<:end_time ORDER BY m.dateTime DESC"),
})
@Entity
